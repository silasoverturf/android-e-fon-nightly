package 
{
	...
	public class combatArmsNoBlur extends MovieClip 
	{
		//Img loading
		...
		//Public Funtion
		public function combatArmsNoBlur()
		{
			...
			TweenMax.allTo(stfHome.textFields,0,{x:"+200",autoAlpha:0},0);
			TweenMax.allTo(stfHome.textFields,1.5,{delay:0.5,x:"-200",autoAlpha:1, ease:Sine.easeInOut, onComplete:stfHome.addEventListener(MouseEvent.CLICK, loadXML)
},0.1)
		...
		private function subType(event:Event = null):void
		{
			...
			TweenMax.allTo(stfHome.textFields,1,{x:"-320",autoAlpha:0, ease:Sine.easeInOut},0.1);
			TweenMax.allTo(stfSubtype.textFields,0,{autoAlpha:0, ease:Sine.easeInOut},0);
		
			TweenMax.allTo(stfSubtype.textFields,1,{x:"-320",autoAlpha:1, ease:Sine.easeInOut},0.1);
		...
		private function weaponDetail(event:MouseEvent):void
		{
			...
			TweenMax.allTo(stfSubtype.textFields,1,{x:"-320",autoAlpha:0, ease:Sine.easeInOut},0.1);
			TweenMax.to(weaponDetailMc,1,{delay:1,x:10, autoAlpha:1, ease:Sine.easeInOut});
		...
		private function home(event:MouseEvent):void
		{
			...
			TweenMax.to(weaponDetailMc,1,{x:340, autoAlpha:0, ease:Sine.easeInOut});
			
			TweenMax.allTo(stfHome.textFields,1,{delay:1, x:"+320",autoAlpha:1},0.1);
			TweenMax.allTo(stfSubtype.textFields,1,{x:"+320",autoAlpha:0, ease:Sine.easeInOut, onComplete:stfSubtype.deactivate},0.1);
		...
		private function mouseUpHandler(event:MouseEvent):void 
		{
			...
			ThrowPropsPlugin.to(weaponDetailMc, {throwProps:{y:{velocity:yVelocity, max:78, min:470-weaponDetailMc.height, resistance:300} }, ease:Strong.easeOut}, 3, 0.3, 1);
		}
		//Throwprops End
    }
}