...
The portal connection is currently acieved with HTTP and TLS. The conventional HTML is loaded and parsed manually. All variables are POSTed using the AS3 "URLRequestMethod" and transported with HTTP/TLS
